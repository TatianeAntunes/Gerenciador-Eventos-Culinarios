...
public class IngredientePadraoModel {
    ...
    public void atualizarIngred(Map<Integer, Double> dados, ItemModel itemModel) throws SQLException {
        ...
        try {
            ...
            String query = "DELETE FROM ingred_item WHERE cod_item='" + codItem + "'";
            ...
            for(Integer codIng : dados.keySet()) {
                ...
                double qtdIng    = dados.get(codIng);

                // cria o comando
                query = "INSERT INTO ingred_item (cod_item, cod_ing, qtd_ing) VALUES (" + codItem+ "," + codIngred + "," + qtdIng + ")";
