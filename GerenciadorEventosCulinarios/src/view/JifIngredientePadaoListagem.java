...
import controller.IngredientePadraoController;
...
public class JifIngredientePadaoListagem extends javax.swing.JInternalFrame {

    private IngredienteController ingredC = new IngredienteController();
    private ItemModel itemModel;
    private double totalDoItem = 0;
    
    private IngredientePadraoController ingredientePadraoController;
    public IngredientePadraoController getIngredientePadraoController() { return ingredientePadraoController; }
    public void setIngredientePadraoController(IngredientePadraoController ingredientePadraoController) { this.ingredientePadraoController = ingredientePadraoController; }
    ...
    public JifIngredientePadaoListagem(ItemModel itemModel){
        ...
        ingredientePadraoController = new IngredientePadraoController(itemModel);//novo
        this.tabelaIngredDoCardapio.setModel(ingredientePadraoController.getTableModel());
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        ...
        ingredientePadraoController.atualizarIngred(dados, this.itemModel);
