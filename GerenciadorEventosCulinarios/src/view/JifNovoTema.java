...
public class JifNovoTema extends javax.swing.JInternalFrame {
    ...
    public JifNovoTema() {initComponents();}
    public JifNovoTema(TemaController temaController) {
        initComponents();
    ...
    private void initComponents() {
        ...
        btnCadastrarTema.setText("Cadastrar");
    ...
    private void btnCadastrarTemaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCadastrarTemaActionPerformed
        if (this.temaController.novoTema(this.txtNomeTema.getText()) == true) {
